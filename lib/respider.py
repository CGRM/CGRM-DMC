#! /usr/bin/env python
#------------------------------------------------------------------------------
#     Purpose: Provide class to handle instrument response file
#       Usage:
#              All response files of each channels are organized as follow
#              └── AH_SACPZs
#                  ├── PZs_AH_ANQ_BHE_201201_201304
#              └── ZJ_SACPZs
#                  ├── PZs_ZJ_BEL_SHE_201404_201410
#               First subdirs are network.
#               Response files are organized by 
#               PZs_<net>_<sta>_<cha>_<starttime>_<endtime>
#     
#      Author: Xiao Xiao
